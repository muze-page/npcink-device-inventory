...
const App: React.FC<Props> = ({ data }) => {
  ...
  const formattedData = (item: ComputerNet) => {
    const arr = [
      ...
      { key: "3", label: "速度", value: item.speed },
      { key: "4", label: "类型", value: item.type },
      { key: "5", label: "IPV4", value: item.ip4 },
      { key: "6", label: "IPV4子网掩码", value: item.ip4subnet },
      { key: "7", label: "IPV6", value: item.ip6 },
      { key: "8", label: "IPV6子网掩码", value: item.ip6subnet },
