...
if (!class_exists('Npcink_Device_Inventory_Admin_Uninstall')) {
    class Npcink_Device_Inventory_Admin_Uninstall
    {
        ...
        public static function run()
        {
             ...
             * 引入获取选项的方法
             */
            require plugin_dir_path(__FILE__) . 'npcink-device-inventory-admin-interface.php';

            //获取选项值
            $config = Npcink_Device_Inventory_Admin_Interface::get_seting('delete_mysql');

            //进行判断
            if ($config) {
                $result = [
                    Npcink_Device_Inventory_Admin_Interface::$table_pc_name,
                    Npcink_Device_Inventory_Admin_Interface::$table_style_name,
                    Npcink_Device_Inventory_Admin_Interface::$table_manual_name,
                    Npcink_Device_Inventory_Admin_Interface::$table_auto_name
                ];
        ...
        {
            // 删除插件设置
            delete_option(Npcink_Device_Inventory_Admin_Interface::$option);
        }
    }
}
