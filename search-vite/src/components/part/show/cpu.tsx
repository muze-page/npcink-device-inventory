...
const App: React.FC<Props> = ({ data }) => {
  ...
  const Items = [
    ...
    { label: "L1 数据", value: formatBytes(data.cache.l1d, "MB") },
    { label: "L1 缓存", value: formatBytes(data.cache.l1i, "MB") },
    { label: "L2 缓存", value: formatBytes(data.cache.l2, "MB") },
    { label: "L3 缓存", value: formatBytes(data.cache.l3, "MB") },
