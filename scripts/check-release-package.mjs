...
const requiredEntries = [
  ...
  `${slug}/vite-admin/src/main.tsx`,
  `${slug}/vite-admin/src/pages/index.tsx`,
  `${slug}/vite-admin/package.json`,
  `${slug}/vite-admin/package-lock.json`,
  `${slug}/vite-admin/vite.config.ts`,
  `${slug}/README.txt`,
  `${slug}/LICENSE.txt`,
];
